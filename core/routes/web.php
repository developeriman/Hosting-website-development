...
Route::controller('User\InvoiceController')->prefix('invoice')->name('user.invoice.')->group(function(){
    Route::post('/create','create')->name('create');
});
// Payment
Route::prefix('payment')->name('payment.')->controller('Gateway\PaymentController')->group(function(){
    Route::get('confirm', 'guestConfirm')->name('confirm');
    // Route::get('manual', 'manualDepositConfirm')->name('manual.confirm');
    // Route::post('manual', 'manualDepositUpdate')->name('manual.update');
});
Route::controller('User\UserController')->group(function(){
     Route::any('thank-you', 'guestHistory')->name('payment.history'); 
});
...
Route::controller('SiteController')->group(function () {
    ...
    Route::get('/domain/buy', 'index')->name('domain');
